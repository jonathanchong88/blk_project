          ...
          <button 
            onClick={() => {
              if (token && ['admin', 'editor', 'developer'].includes(userRole)) {
                ...
                alert("✨ Opps! Only our Community Leaders can create new events. If you have something special to share, please contact an administrator! / 只有社区领导可以创建新活动。如果您有特别的内容想分享，请联系管理员！");
              }
            }} 
            title="Create Event" 
              ...
              <div key={event.id} className="event-card" onClick={() => navigate(`/events/${event.id}`)} style={{ cursor: 'pointer' }}>
                ...
                <div className="event-content">
                  ...
                  <div className="card-actions">
                    ...
                    <button className="icon-btn share-icon-btn" onClick={(e) => {
                      e.stopPropagation();

...
const resources = {
  en: {
    translation: {
      ...
      "news.create_title": "Create News",
      "news.edit_title": "Edit News",
      "news.back_to_news": "Back to News",
      "news.view_past": "View Past News",
      "news.search_placeholder": "Search news by title...",
      "news.sort_date": "Date",
      "news.sort_name": "Name",
      "news.empty": "No upcoming news at the moment.",
      "news.past_empty": "No past news found.",
      "news.loading": "Loading...",
      "news.not_found": "News not found.",
      "news.edit": "Edit",
      "news.delete": "Delete",
      "news.confirm_delete": "Are you sure you want to delete this news item?",
      "news.alert.delete_failed": "Failed to delete news.",
      "news.documents_section": "Attachments",
      "news.download": "Download",
      "news.unknown_type": "Unknown file type",

      "news.form.title": "News Title",
      "news.form.description": "Description (URLs will be automatically linked)",
      "news.form.image_url": "Image URL",
      "news.form.image_upload": "Upload Image",
      "news.form.image_url_placeholder": "Image URL (Optional)",
      "news.form.image_uploaded": "Image uploaded!",
      "news.form.image_upload_failed": "Image upload failed.",
      "news.form.has_end_date": "Has End Date?",
      "news.form.documents": "Documents (PDF, DOC, Image, etc.)",
      "news.form.add_documents": "+ Add Files (PDF, DOC, Image…)",
      "news.form.files": "files",
      "news.form.file_s": "file(s)",
      "news.form.limit_reached": "limit reached",
      "news.form.doc_ready": "Ready to upload",
      "news.form.doc_uploading": "Uploading…",
      "news.form.doc_uploaded": "Uploaded",
      "news.form.doc_failed": "Upload failed",
      "news.form.title_required": "News title is required.",
      "news.form.date_from_required": "Start date is required.",
      "news.form.upload_error": "Some files failed to upload. Please remove them or retry.",
      "news.form.save_failed": "Failed to save news.",
      "news.form.uploading": "Uploading",
      "news.form.saving": "Saving…",
      "news.form.update": "Update News",
      "news.form.create": "Create News",
      "news.form.cancel": "Cancel"
    }
  },
  zh: {
    translation: {
      ...
      "news.create_title": "创建新闻",
      "news.edit_title": "编辑新闻",
      "news.back_to_news": "返回新闻",
      "news.view_past": "查看过往新闻",
      "news.search_placeholder": "按标题搜索新闻...",
      "news.sort_date": "日期",
      "news.sort_name": "名称",
      "news.empty": "暂无最新新闻。",
      "news.past_empty": "未找到过往新闻。",
      "news.loading": "加载中...",
      "news.not_found": "未找到该新闻。",
      "news.edit": "编辑",
      "news.delete": "删除",
      "news.confirm_delete": "确定要删除这条新闻吗？",
      "news.alert.delete_failed": "删除新闻失败。",
      "news.documents_section": "附件",
      "news.download": "下载",
      "news.unknown_type": "未知文件类型",

      "news.form.title": "新闻标题",
      "news.form.description": "描述（网址将自动转为可点击链接）",
      "news.form.image_url": "图片网址",
      "news.form.image_upload": "上传图片",
      "news.form.image_url_placeholder": "图片网址（可选）",
      "news.form.image_uploaded": "图片上传成功！",
      "news.form.image_upload_failed": "图片上传失败。",
      "news.form.has_end_date": "有截止日期？",
      "news.form.documents": "文件（PDF、DOC、图片等）",
      "news.form.add_documents": "+ 添加文件（PDF、DOC、图片…）",
      "news.form.files": "个文件",
      "news.form.file_s": "个文件",
      "news.form.limit_reached": "已达上限",
      "news.form.doc_ready": "准备上传",
      "news.form.doc_uploading": "上传中…",
      "news.form.doc_uploaded": "已上传",
      "news.form.doc_failed": "上传失败",
      "news.form.title_required": "新闻标题为必填项。",
      "news.form.date_from_required": "开始日期为必填项。",
      "news.form.upload_error": "部分文件上传失败，请删除后重试。",
      "news.form.save_failed": "保存新闻失败。",
      "news.form.uploading": "上传中",
      "news.form.saving": "保存中…",
      "news.form.update": "更新新闻",
      "news.form.create": "创建新闻",
      "news.form.cancel": "取消"
    }
  }
};
